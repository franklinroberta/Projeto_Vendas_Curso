...
public void ConsultaEstoqueMinino(){
    int delay = 5000;
    int intervalo = 1000;
 ...
 timer.scheduleAtFixedRate(new TimerTask(){
     public void run(){
         ...
         JOptionPane.showMessageDialog(null, "Consulta estoque minino");
    ...
    private void initComponents() {
        ...
        jMenuItem7.setText("Exibir relatório de Clientes");
